...
namespace WacK
{
	...
	public partial class OrientationDetect : Node
	{
		[Signal]
		public delegate void OrientationChangeEventHandler(ScreenOrientation orientation);
		...
		{
			GetTree().Root.Connect("size_changed",new Callable(this,nameof(OnScreenResize)));
